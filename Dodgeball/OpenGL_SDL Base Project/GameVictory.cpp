...
GameVictory::GameVictory(GameScreenManager * currentManager, int finalScore) : GameScreen() {
...
void GameVictory::Update(float deltaTime, SDL_Event e) {
...
void GameVictory::OutputLine(float x, float y, string text) {
